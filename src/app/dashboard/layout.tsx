...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen pt-20">
      {/* Sidebar */}
      <div className="fixed inset-y-0 left-0 z-30 pt-20">
        <motion.div
          initial={{ x: -280 }}
          animate={{ x: isSidebarOpen ? 0 : -280 }}
          transition={{ duration: 0.3 }}
          className="flex flex-col h-full w-72 bg-white shadow-xl"
        >
          {/* Toggle button */}
          <button
            onClick={() => setIsSidebarOpen(!isSidebarOpen)}
            className="absolute right-0 top-6 translate-x-full bg-white p-3 rounded-r-lg shadow-lg"
          >
            <svg
